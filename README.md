<div align="center">
  <img src="assets/banner.png" alt="PyRu - High-performance Python web scraper">
</div>
...
<details>
<summary><strong>Worked example: 50 pages, JSON to jq</strong></summary>
...
See [`SECURITY.md`](SECURITY.md) for responsible disclosure and supply-chain posture:

- **Zero runtime Python dependencies.** The CLI is stdlib-only.
- **In-tree PEP 517 build backend** at [`_build/`](_build/) — no setuptools, no hatchling, no maturin.
